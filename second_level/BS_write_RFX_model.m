function BS_write_RFX_model(subs,exclude_subs,model,modelname,skern)
...
templateDir      =  '/home/nold/Desktop/PEEP/fMRI/Analysis/fmri_analysis/spm_bids_pipeline/templates/';

%find mask, make sure it's there
mask     = fullfile(templateDir, 'brainstem_mask.nii');
...
if model == 1 && strcmp(modelname,['complete_onset_stimulus_' num2str(skern) 'mm'])
...
%         'pressure_exHi>exLo_nacl','pressure_exLo>exHi_nac'};%,'heat>pressure_nacl','pressure>heat_nacl','rating'};
    ...
    for e = 1:n_cons
        ...
        %matlabbatch{e}.spm.stats.factorial_design.cov.cname = 'relFTP';
...
elseif  model == 1 && strcmp(modelname,'split_onset_stimulus')
