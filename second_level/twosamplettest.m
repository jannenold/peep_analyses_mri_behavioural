...
file_tmp1= 's%dw_nlco_dartelcon_0098.nii';
% inter treatment exercise heat con097
% inter treatment exercise pressure con098
...
pwc_vec_new = [pwc_vec_female;pwc_vec_male];
...
for e = 1:n_cons
    ...
    co_c = co_c + 1;
    all_niftis_female = cell(length(subs_female), 1);
    ...
    matlabbatch{e}.spm.stats.factorial_design.cov.c = [pwc_vec_new];
    matlabbatch{e}.spm.stats.factorial_design.cov.cname = 'ftp';
    %matlabbatch{1}.spm.stats.factorial_design.cov = struct('c', {}, 'cname', {}, 'iCFI', {}, 'iCC', {});
    matlabbatch{e}.spm.stats.factorial_design.cov.iCFI = 2;
