function plot_8betas_inter_treatment_exercise_gender
...
if barplot == 1
    ...
    val_bar = [mean(betas(gender_vec==1,1)) mean(betas(gender_vec==1,2)) mean(betas(gender_vec==1,3)) mean(betas(gender_vec==1,4));...
        mean(betas(gender_vec==-1,1)) mean(betas(gender_vec==-1,2)) mean(betas(gender_vec==-1,3)) mean(betas(gender_vec==-1,4))];
    val_se = [std(betas(gender_vec==1,1))/sr1 * err std(betas(gender_vec==1,2))/sr1 * err std(betas(gender_vec==1,3))/sr1 * err std(betas(gender_vec==1,4))/sr1 * err;...
        std(betas(gender_vec==-1,1))/sr2 * err std(betas(gender_vec==-1,2))/sr2 * err std(betas(gender_vec==-1,3))/sr2 * err std(betas(gender_vec==-1,4))/sr2 * err];
    ...
    tbl = table(betas);
    writetable(tbl,sprintf('8betas_inter_treat_exercise_gender_%d_%d_%d.csv',coordinate(1),coordinate(2),coordinate(3)));
