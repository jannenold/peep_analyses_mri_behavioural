...
if barplot == 1
    ...
    plot(pwc_vec(gender_vec==-1),betas(:,1),'.','MarkerSize',ms,'MarkerFaceColor',col.nacl,'MarkerEdgeColor',col.nacl);hold on;
    plot(pwc_vec(gender_vec==-1),betas(:,2),'.','MarkerSize',ms,'MarkerFaceColor',col.nlx,'MarkerEdgeColor',col.nlx);hold on;

    %plot(pwc_vec,betas(:,1),'.','MarkerSize',ms,'MarkerFaceColor',col.nacl,'MarkerEdgeColor',col.nacl);hold on;
    %plot(pwc_vec,betas(:,2),'.','MarkerSize',ms,'MarkerFaceColor',col.nlx,'MarkerEdgeColor',col.nlx);hold on;
    h = lsline;
...
%cd('/home/nold/Desktop/PEEP/fMRI/Figures/');
%    exportgraphics(gcf,sprintf('cor_heatexHiexLo_sal_male_ftp_%d_%d_%d.png',coordinate(1),coordinate(2),coordinate(3)),'Resolution',500)
    %saveas(gcf,sprintf('4betas_gender_%d_%d_%d.svg',coordinate(1),coordinate(2),coordinate(3)))
