function plot_2betas_intensity
...
% Pressure Int NLX > SAL
% [54 6 -9]; 
% [-32 -4 -4]; 
% [56 8 39]; 

% Pressure Int SAL > NLX
% [-6 -21 -12]
...
col.both = [45 154 166; 242 92 5]/255;
...
if pub
    lw = 0.8;
    size1plot = [165 135]*2; %for figures and publication
    afs = 6;
    xfs = 7.5;
    yfs = 8;
else
...
if barplot == 1
    ...
    xpos = [1 2];
    y = [val_bar(1,:)-val_se(1,:) ; val_bar(1,:)+val_se(1,:)];% val_bar(2,:)+val_se(2,:)];
...
%     
%     filename = sprintf(['betas_%s_%s_%s.svg',num2str(coordinate(1)),num2str(coordinate(2)),num2str(coordinate(3))])
%     print(sprintf(['home/nold/Desktop/PEEP/fMRI/Figures/betas_%s_%s_%s.svg',num2str(coordinate(1)),num2str(coordinate(2)),num2str(coordinate(3))]),'-dsvg','-painters','-noui', '-r500');
%     % print -dsvg -painters -noui -r500 /home/tinnermann/remi3/Figures/betas_0_20_-9.svg
