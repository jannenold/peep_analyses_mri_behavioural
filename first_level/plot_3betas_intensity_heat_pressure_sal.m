function plot_3betas_intensity_heat_pressure_sal
...
if barplot == 1
    ...
    val_se = [std(betas(:,1))/sr1 * err std(betas(:,2))/sr1 * err std(betas(:,3))/sr2 * err];
   ...
   %exportgraphics(gcf,sprintf('3betas_intensity_%d_%d_%d.png',coordinate(1),coordinate(2),coordinate(3)),'Resolution',500)
    tbl = table(betas);
    writetable(tbl,sprintf('3betas_intensity_modality_%d_%d_%d.csv',coordinate(1),coordinate(2),coordinate(3)));
