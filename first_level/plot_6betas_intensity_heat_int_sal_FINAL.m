function plot_6betas_intensity_heat_int_sal_FINAL
...
%   saveas(gcf,sprintf('6betas_intensity_pressure_%d_%d_%d.svg',coordinate(1),coordinate(2),coordinate(3)))
   tbl = table(betas);
   writetable(tbl,sprintf('6betas_intensity_heat_int_sal_%d_%d_%d.csv',coordinate(1),coordinate(2),coordinate(3)));
