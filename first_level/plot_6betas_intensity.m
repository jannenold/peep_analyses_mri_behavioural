function plot_6betas_intensity
...
% -3 -21 -6
% 39 0 18
% 39 10 6 % no interaction but main effect
...
if barplot == 1
  ...
  %   tbl = table(betas);
   % writetable(tbl,sprintf('6betas_intensitiy_modality_%d_%d_%d.csv',coordinate(1),coordinate(2),coordinate(3)));



   %cd('/home/nold/Desktop/PEEP/fMRI/Figures/');
   %exportgraphics(gcf,sprintf('6betas_intensity_pressure_%d_%d_%d.png',coordinate(1),coordinate(2),coordinate(3)),'Resolution',500)
