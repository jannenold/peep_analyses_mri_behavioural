function plot_6betas_intensity_modality
...
% Heat: sal nlx  Intensity cons
% ----------------------------
% image_nr = [83 89 84 90 85 91];

% sal Intensity cons
% ----------------------------
 %image_nr = [64 67 65 68 66 69];

% nlx Intensity cons
% ----------------------------
% image_nr = [70 73 71 74 72 75];

% Pressure: sal nlx  Intensity cons
% ----------------------------
 image_nr = [86 92 87 93 88 94];
