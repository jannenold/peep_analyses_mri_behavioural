...
plot(gender_vec,betas,'.');hold on;
h = lsline;
set(h(1),'color',[0 0 0],'LineWidth',lw);

p1 = plot(gender_vec==-1,betas(gender_vec==-1),'.','MarkerFaceColor', col.nacl,'MarkerEdgeColor',col.nacl,'MarkerSize',ms);hold on
p2 = plot(gender_vec==1,betas(gender_vec==1),'.','MarkerFaceColor', col.nlx,'MarkerEdgeColor',col.nlx,'MarkerSize',ms);
